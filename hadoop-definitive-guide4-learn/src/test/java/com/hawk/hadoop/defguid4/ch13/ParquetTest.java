...
public class ParquetTest {
	...
	public void testParquetFileUsingAvroProjection() throws IOException {
		...
		Schema projectSchema = new Schema.Parser().parse(getClass().getResourceAsStream("/ProjectedStringPair.avsc"));
		Configuration conf = new Configuration();

		AvroReadSupport.setRequestedProjection(conf, projectSchema);
	...
	public void testParquetFileUsingAvroProjectionAndReadSchema() throws IOException {
		...
		Schema readSchema = new Schema.Parser().parse(getClass().getResourceAsStream("NewStringPair.avsc"));
