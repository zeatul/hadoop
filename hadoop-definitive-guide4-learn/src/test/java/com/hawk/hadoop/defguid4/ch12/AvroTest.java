...
public class AvroTest {
	...
	static class StringPair implements SpecificRecord {
	...
	public void testSchemaResolutionWithNull() throws IOException {
		...
		DatumReader<GenericRecord> reader = new GenericDatumReader<GenericRecord>(schema, newSchema); // write
																										// schema,
																										// read
																										// schema
		Decoder decoder = DecoderFactory.get().binaryDecoder(out.toByteArray(), null);
