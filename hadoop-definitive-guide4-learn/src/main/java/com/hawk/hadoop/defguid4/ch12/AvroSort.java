package com.hawk.hadoop.defguid4.ch12;
...
public class AvroSort extends Configured implements Tool {
	...
	public static class SortMapper<K> extends Mapper<AvroKey<K>, NullWritable, AvroKey<K>, AvroValue<K>> {
		@Override
	...
	public static class SortReducer<K> extends Reducer<AvroKey<K>, AvroValue<K>, AvroKey<K>, NullWritable> {
